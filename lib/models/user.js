...
class User {
  ...
  async updateLocation(id, location) {
    ...
    if (location == null) throw new Error('location parameter cannot be null');
    if (location.type == null || location.coordinates == null) {
      throw new Error('location parameter is not a valid GeoJSON object instance');
    }
